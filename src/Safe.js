  ...
  return (
    ...
    <div className="PLV">
      <header className="header">
            ...
            <Modal visible={this.state.visible} width="900" effect="fadeInDown" onClickAway={()=>this.closeModal()} className="modal">
            <Preview>
                 {
                     ({children})=>(
                         <Container>
            ...
            <div className="tab-content">
                    <div className="tab-pane fade show active" id="components" role="tabpanel" >
                       ...
                       <div className="d-flex flex-column">
                        ...
                        <div className="dedzone">

                         <Row className="page-builder">
...
<div className="deletebuttons">    
  <Button color="danger" onClick={this._clearState}> <IoMdTrash/> <div> Delete All</div> </Button>
 <div className="trash"><Trash> <IoIosTrash/><div> Elements</div> </Trash></div>
